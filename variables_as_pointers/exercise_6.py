# The following program is nearly identical to that of the previous exercise. However, this time, it 
# should create a shallow copy of dict1. Be careful: you're not allowed to use the copy module in 
# this exercise.
...
dict2 = dict(dict1)                                 # MODIFICATION MADE HERE!
                                                    # I was correct on all of the answers below!
